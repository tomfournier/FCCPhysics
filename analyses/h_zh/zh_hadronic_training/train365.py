...
def load_process(fIn, variables, target=0):
    ...
    if target == 1:
        weight = 0.15*3e6 / ev_proc # 200 fb-1 for each Higgs decay == equal
...
sig_procs = [f'wzp6_ee_{x}H_H{y}_ecm365' for x in z_decays for y in h_decays]

#sig_procs = ["wz3p6_ee_ZH_Zqq_ecm365"]
bkg_procs = ['p8_ee_WW_ecm365', 'wz3p6_ee_uu_ecm365', 'wz3p6_ee_dd_ecm365', 'wz3p6_ee_ss_ecm365', 'wz3p6_ee_cc_ecm365', 'wz3p6_ee_bb_ecm365'] # 'p8_ee_ZZ_ecm365', p8_ee_Zqq_ecm365
#bkg_procs = ['p8_ee_WW_ecm365', 'p8_ee_Zqq_ecm365']



inputDir = "/ceph/submit/data/group/fcc/ee/analyses/zh/hadronic/treemaker/ecm365/"
...
os.system(f"python FCCPhysics/analyses/h_zh/zh_hadronic_training/evaluate365.py --tag {tag}")