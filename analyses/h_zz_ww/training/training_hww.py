...
tag = "ww_final_test"
# ww nominal
# ww_test = 1e6 max events
# ww_v1 without fit vars
# ww_v2 all bkgs --> very slightly better
# ww_v4 also recoil vars

inputDir = "/ceph/submit/data/group/fcc/ee/analyses/h_zz_ww/treemaker/ecm240/stage2/HWW"
...
#vars_kinematics = ["W1_WW_m", "W2_WW_m", "Z_WW_p", "Z_WW_theta", "H_WW_p", "H_WW_theta"] # remove fit vars
